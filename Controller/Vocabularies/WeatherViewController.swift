...
class WeatherViewController: UITableViewController, AVAudioPlayerDelegate, AVSpeechSynthesizerDelegate {
    ...
    func CustomCellTapButtonCall2(cell: UITableViewCell, pushTime: TimeInterval) {
        ...
        sentenceView.weatherSentenceArray[indexPathTapped.section].names[indexPathTapped.row].hasFavorited2 = !hasFavorited
        saveFavorites()
    ...
    func CustomCellTapButtonCall3(cell: UITableViewCell, pushTime: TimeInterval) {
        ...
        sentenceView.weatherSentenceArray[indexPathTapped.section].names[indexPathTapped.row].hasFavorited3 = !hasFavorited
        saveFavorites()
    ...
    func CustomCellTapButtonCall4(cell: UITableViewCell, pushTime: TimeInterval) {
        ...
        sentenceView.weatherSentenceArray[indexPathTapped.section].names[indexPathTapped.row].hasFavorited4 = !hasFavorited
        saveFavorites()
    ...
    func addRemindList(tappedRow: Int) {
        let data = ["sentence": sentenceView.weatherSentence[tappedRow]]
        ...
        if var savedRemindData = UserDefaults.standard.stringArray(forKey: "remind") {
            savedRemindData.append(sentenceView.weatherSentence[tappedRow])
            UserDefaults.standard.set(savedRemindData, forKey: "remind")
        } else {
            UserDefaults.standard.set([sentenceView.weatherSentence[tappedRow]], forKey: "remind")
        }
    }
