...
class GreetingsViewController: UITableViewController,AVAudioPlayerDelegate, AVSpeechSynthesizerDelegate {
    ...
    func addRemindList(tappedRow: Int, remindPattern: String) {
        let sentence = sentenceView.sentence[tappedRow]
